...
def generate_launch_description():
    ...
    ekf_pkg = FindPackageShare(package='robot_localization').find('robot_localization')
    position_x = '0.0'
    position_y = '0.0'
    orientation_yaw = '0.0'
    ...
    ekf_params = join(pkg_share,'config','ekf.yaml')
    ...
    #     PythonLaunchDescriptionSource(join(ekf_pkg, "launch", "ekf.launch.py")),
    #     launch_arguments={
    #         'config_file': ekf_params
    #     }.items()
    # )
